<?php
loginpagechecker('vaultuser', 'vault');
involve('stafffunctions');

begin('Vault Authenticator'); ?>
...
<body class="crm_body_bg">
    ...
    <section class="main_content dashboard_part" style="background-image:url('vv/assets/images/bg/hero.jpg');">
        ...
        <div class="main_content_iner ">
            <div class="container-fluid p-0">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="white_box mb_30" style="background-color:transparent;">
                            <div class="row justify-content-center">
                                <div class="col-lg-6">
                                                ...
                                                <div class="">
                                                 ...
                                                 <div class="">
                                                    <input type="password" class="form-control"
                                                        placeholder="Enter Vault Pin" name="vaultpin">
                                                </div>
